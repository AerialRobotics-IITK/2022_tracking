...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/harshit/2022_tracking/src/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/harshit/2022_tracking/devel/.private/rotors_gazebo_plugins)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/harshit/2022_tracking/install)
...
if(NOT "/home/harshit/2022_tracking/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/harshit/2022_tracking/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harshit/2022_tracking/src/rotors_simulator/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/harshit/2022_tracking/devel/.private/rotors_gazebo_plugins/lib;/home/harshit/2022_tracking/devel/lib;/home/harshit/catkin_ws/devel/lib;/opt/ros/noetic/lib)
