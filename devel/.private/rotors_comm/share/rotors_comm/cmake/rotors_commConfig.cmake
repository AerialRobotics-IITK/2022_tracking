...
if("TRUE" STREQUAL "TRUE")
  set(rotors_comm_SOURCE_PREFIX /home/harshit/2022_tracking/src/rotors_simulator/rotors_comm)
  set(rotors_comm_DEVEL_PREFIX /home/harshit/2022_tracking/devel/.private/rotors_comm)
  ...
  set(rotors_comm_INSTALL_PREFIX /home/harshit/2022_tracking/install)
...
if(NOT "/home/harshit/2022_tracking/devel/.private/rotors_comm/include " STREQUAL " ")
  set(rotors_comm_INCLUDE_DIRS "")
  set(_include_dirs "/home/harshit/2022_tracking/devel/.private/rotors_comm/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harshit/2022_tracking/src/rotors_simulator/rotors_comm/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/harshit/2022_tracking/devel/.private/rotors_comm/lib;/home/harshit/2022_tracking/devel/lib;/home/harshit/catkin_ws/devel/lib;/opt/ros/noetic/lib)
